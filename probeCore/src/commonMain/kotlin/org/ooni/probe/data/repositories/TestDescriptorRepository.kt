    ...
    private fun TestDescriptor.toModel() =
        Descriptor(
            ...
            netTests = nettests
                ...
                .orEmpty(),
            nameIntl = name_intl?.let { json.decodeFromString<Map<String, String>>(it) },
            shortDescriptionIntl = short_description_intl?.let { json.decodeFromString<Map<String, String>>(it) },
            descriptionIntl = description_intl?.let { json.decodeFromString<Map<String, String>>(it) },
            icon = icon,
            color = color,
            animation = animation,
