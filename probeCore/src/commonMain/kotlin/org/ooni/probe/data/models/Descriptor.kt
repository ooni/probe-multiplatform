...
data class Descriptor(
    ...
    val nameIntl: Map<String, String>?,
...
fun Descriptor.toDb(json: Json) =
    TestDescriptor(
        ...
        name_intl = nameIntl?.let { json.encodeToString(it) },
        short_description_intl = shortDescriptionIntl?.let { json.encodeToString(it) },
        description_intl = descriptionIntl?.let { json.encodeToString(it) },
        icon = icon,
        color = color,
        animation = animation,
